    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        LocalDateTime ldtTo = SchedulingAbstract.getConvStringToDateTime(this.dateToJPan.getDateDayString() + this.dateToJPan.geDateMonthString() + this.dateToJPan.getDateYearString() + "0000");
         ...
         //sets the main doctor to the selected Dr in the combo box - this is a static variable used to hold any
           ...
           SysUserDoctor.currentDoctor = (SysUserDoctor) SystemUserComponent.getSystemUserComponent(JPartPanelSelDrComboFlow.getInstance().getDoctorString());
        ...
        if (lstFoundAvailableApps.isEmpty()){
            ...
            lstFoundAvailableApps = SysUserDoctor.getDocsAvailableAppointments(SysUserDoctor.currentDoctor, ldtFrom, ldtTo);
        }
        else{
